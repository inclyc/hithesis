...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/stmv-image.pdf}
    \caption{卫星烟草花叶病毒 (STMV) 500步模拟，形态学特征}
    \label{fig:stmv-dynamics}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/stmv.pdf}
